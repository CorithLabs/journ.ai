  ...
  return (
    <div className="flex flex-col h-full" data-testid="itinerary-view">
      ...
      {/* The one line a traveller wants on opening: is this trip happening,
          ...
          A panel stood here briefly, carrying readiness counts and what was
          on today. It was useful and still not worth it: the header does not
          scroll, so whatever sits here is paid for on every screen of every
          day, and it pushed the cards down for the whole trip to say
          something that mattered on the way in. */}
